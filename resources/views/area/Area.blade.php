    ...
    <div class="row gutters">
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        @if(!empty($single_data))
          {!! Form::open(array('route' =>['area.update', $single_data->id],'method'=>'PUT','files'=>true)) !!}
          <?php $info ="Update";?>
        @else
        ...
        <div class="card">
          <div class="card-header">
            <div class="card-title">{{$info}} Area</div>
          </div>
          <div class="card-body">
            <!-- Row start -->
            <div class="row gutters">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="field-wrapper">
                  <div class="input-group">
                    <input class="form-control @error('address') is-invalid @enderror" type="text" name="address" value="{{(!empty($single_data->address))?$single_data->address:''}}" autocomplete="off">
                  </div>
                ...
                <!-- Field wrapper start -->
                <div class="field-wrapper">
                  <select class="select-single select2 js-state @error('district_id') is-invalid @enderror" data-live-search="true" name="district_id"  required="">
