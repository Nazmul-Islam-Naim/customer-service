      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
          <div class="card-header">
            ...
            <a class="btn btn-success" href="javascript:void(0)" id="createNewProduct"> <i class="icon-plus-circle"></i> Create New Product</a>
          </div>
          <div class="card-body">
...
<div class="modal fade" id="editModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              <h4 class="modal-title" id="editModelHeading"></h4>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
              <form id="editProductForm" name="editProductForm" class="form-horizontal">
                <input type="hidden" name="product_id" id="product_id">
                  ...
                  <div class="field-wrapper">
                    <div class="input-group">
                      <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="editName" value="{{(!empty($single_data->name))?$single_data->name:''}}" required="" autocomplete="off">
                    </div>
                    <div class="field-placeholder">Name<span class="text-danger">*</span></div>
                  </div>
                  <!-- Field wrapper end -->
...
<script>
    ...
    $('body').on('click', '.editProduct', function () {
      ...
      $.get("{{ route('products.index') }}" +'/' + product_id +'/edit', function (data) {
          $('#editModelHeading').html("Edit Product");
    ...
    $('#updateBtn').click(function (e) {
        ...
        var link = '{{route("products.update",":id")}}';
